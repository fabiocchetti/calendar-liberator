...
// --- Structure -------------------------------------------------------------
{
    const ics = new ICSGenerator('UTC+1').generate([baseEvent]);
...
// --- UTC conversion, winter (Europe/Rome = UTC+1) ---------------------------
{
    ...
    const ics = new ICSGenerator('UTC+1').generate([winter]);
...
// --- All-day events ----------------------------------------------------------
{
    ...
    const ics = new ICSGenerator('UTC+1').generate([allDay]);
...
// --- Text escaping -----------------------------------------------------------
{
    ...
    const ics = new ICSGenerator('UTC+1').generate([tricky]);
...
// --- Organizer filtering -----------------------------------------------------
{
    ...
    const ics = new ICSGenerator('UTC+1').generate([noOrg]);
    ...
    const ics2 = new ICSGenerator('UTC+1').generate([oneWord]);
...
{
    const ics = new ICSGenerator('UTC-5').generate([baseEvent]);
